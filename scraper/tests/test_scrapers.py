...
from scrapers.morizon_scraper import MorizonScraper, create_morizon_category_urls
from scrapers.oto_dom_scraper import OtoDomScraper, create_otodom_category_urls
from tests._html import (MORIZON_ITEM_DETAIL_HTML,
                         MORIZON_ITEMS_HTML,
                         OTODOM_ITEM_DETAIL_HTML,
                         OTODOM_ITEMS_HTML)
...
class TestOtoDomScraper:
    ...
    def test_scrape_all_items(self):
        otodom = OtoDomScraper()
        otodom.category_urls = ['https://www.otodom.pl/wynajem/pokoj/warszawa/?nrAdsPerPage=72']
    ...
    def test_parse_preview_item_correct(self):
        ...
        assert data['thumbnail_url'] == None
        assert data[
                   'url'] == 'https://www.otodom.pl/oferta/marina-mokotow-3-pokoje-bezposrednio-ID35ZHy.html#845e0b319d'
...
class TestMorizonScraper:
    ...
    def test_scrape_all_items(self):
        morizon = MorizonScraper()
        morizon.category_urls = ['https://www.morizon.pl/do-wynajecia/mieszkania/warszawa/stare-miasto/']
    ...
    def test_parse_preview_item_correct(self):
        ...
        assert data['thumbnail_url'] is None or data['thumbnail_url'].endswith('thumbnail.jpg')
        assert data['url'] == 'https://www.morizon.pl/oferta/wynajem-mieszkanie-warszawa-wilanow-43m2-mzn2036150919'
